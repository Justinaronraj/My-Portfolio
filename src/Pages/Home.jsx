...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Justinaronraj" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/justinaronraj/" },
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                {/* Tech Stack */}
                <div
                  className="flex flex-wrap gap-3 justify-start cursor-pointer text-gray-300 text-sm font-medium"
                  data-aos="fade-up"
                  data-aos-delay="1200"
                >
